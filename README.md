...
*(Aquí puedes agregar capturas de pantalla de tu dashboard una vez las tengas, reemplazando las rutas de las imágenes)*

### Dashboard en Tiempo Real
![Dashboard](frontend/assets/dashboard.png)

### Mapa de Calor (Heatmap)
![Heatmap](frontend/assets/heatmap.png)

---

> "De una movilidad reactiva a una movilidad inteligente y predictiva con datos."
